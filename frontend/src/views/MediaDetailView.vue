...
import { ArrowLeft, Captions, Check, CircleAlert, Clock3, Cloud, Download, ExternalLink, FileVideo2, LoaderCircle, MessageCircle, Play, Star, UserRound } from '@lucide/vue'
import { Capacitor } from '@capacitor/core'
import { useMediaStore, type MediaItem, type MediaSource } from '../stores/media'
